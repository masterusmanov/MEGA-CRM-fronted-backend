...
// Bu hodimlar ro'yhatini jadvalga chiqarish
const listUpdate=()=>{
...
// inputdan kelgan ma'lumotlarni valuesini olib backendga jo'natish
const addEmployee = () => {
  const employee = {
  ...
  // Xodimlar muvaffaqiyatli qo'shilish to'g'risida ma'lumot chiqadi
  ...
  // kelgan ma'lumotlarni bo'shatish
